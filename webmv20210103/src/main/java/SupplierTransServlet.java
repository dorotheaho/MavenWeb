...
/**
 * Servlet implementation class SupplierTransServlet
 */
@WebServlet("/SupplierTransServlet")
public class SupplierTransServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SupplierTransServlet() {
        super();
